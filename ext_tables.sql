...
#
# Table structure for table 'tx_nshelpdesk_domain_model_defaultassignee'
#
CREATE TABLE tx_nshelpdesk_domain_model_defaultassignee (
    uid int(11) NOT NULL auto_increment,
    pid int(11) DEFAULT '0' NOT NULL,

	ticket_type int(11) DEFAULT '0' NOT NULL,
	assignee_id int(11) DEFAULT '0' NOT NULL,
