...
namespace NITSAN\NsHelpdesk\Upgrades;
 ...
 */
#[UpgradeWizard('NsHelpdeskCTypeMigration')]
class NsHelpdeskCTypeMigration implements UpgradeWizardInterface
{
    protected function getListTypeToCTypeMapping(): array
    {
        return [
            'nshelpdesk_helpdesklist'   => 'nshelpdesk_helpdesklist',
            'nshelpdesk_helpdeskticket' => 'nshelpdesk_helpdeskticket',
        ];
    }
    public function getTitle(): string
    {
        return 'Migrate "NS Helpdesk" plugins to content elements.';
    }
    public function getDescription(): string
    {
        return 'The "NS Helpdesk" plugins are now registered as content elements. Update migrates existing records and backend user permissions.';
    }
